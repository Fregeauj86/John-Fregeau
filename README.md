  <div className='min-h-screen bg-gray-100 p-4'>
      ...
      <section className='max-w-4xl mx-auto mb-10 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition-shadow duration-300'>
        ...
        <p className='text-gray-800 leading-relaxed'>
          ...
          I am driven to use my education and skills to defend against cyber threats, contribute to a safer digital future, and make a meaningful impact in the cybersecurity field.
        </p>
      </section>
      <section className='max-w-4xl mx-auto mb-10 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition-shadow duration-300'>
